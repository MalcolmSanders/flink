...
/**
 * Tests for the Kubernetes based leader election and retrieval.
 */
public class KubernetesLeaderRetrievalTest extends TestLogger {

	private static final Logger LOG = LoggerFactory.getLogger(KubernetesLeaderRetrievalTest.class);
	...
	public void before() throws Exception {
		...
		highAvailabilityServices = new KubernetesHaServices(
			apiContext,
