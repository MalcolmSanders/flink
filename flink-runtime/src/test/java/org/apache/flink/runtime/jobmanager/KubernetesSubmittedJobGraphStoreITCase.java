...
/**
 * IT cases for {@link KubernetesSubmittedJobGraphStore}.
 */
public class KubernetesSubmittedJobGraphStoreITCase {

	private static final Logger LOG = LoggerFactory.getLogger(KubernetesSubmittedJobGraphStoreITCase.class);
	...
	public void testPutAndRemoveJobGraph() throws Exception {
		KubernetesSubmittedJobGraphStore jobGraphs = createKubernetesSubmittedJobGraphStore("test-put-and-remove-job-graph");
	...
	public void testRecoverJobGraphs() throws Exception {
		KubernetesSubmittedJobGraphStore jobGraphs = createKubernetesSubmittedJobGraphStore("test-recover-job-graphs");
	...
	public void testConcurrentAddJobGraph() throws Exception {
		KubernetesSubmittedJobGraphStore jobGraphs = null;
		KubernetesSubmittedJobGraphStore otherJobGraphs = null;

		try {
			jobGraphs = createKubernetesSubmittedJobGraphStore("test-concurrent-add-job-graph");

			otherJobGraphs = createKubernetesSubmittedJobGraphStore("test-concurrent-add-job-graph");
	...
	public void testUpdateJobGraphYouDidNotGetOrAdd() throws Exception {
		KubernetesSubmittedJobGraphStore jobGraphs = createKubernetesSubmittedJobGraphStore("test-update-job-graph-you-did-not-get-or-add");

		KubernetesSubmittedJobGraphStore otherJobGraphs = createKubernetesSubmittedJobGraphStore("test-update-job-graph-you-did-not-get-or-add");
	...
	@NonNull
	private KubernetesSubmittedJobGraphStore createKubernetesSubmittedJobGraphStore(String jobPath) {
		return new KubernetesSubmittedJobGraphStore(apiContext, jobPath, localStateStorage);
	}
